...
*Spring Day* fue escrita como homenaje a las víctimas del ferry Sewol en 2014 — jóvenes que se fueron sin despedirse, familias que esperaron noticias que nunca llegaron de la manera que necesitaban recibirlas.

Saber eso no hace la canción más pesada. La hace más verdadera.
...
No dice "quiero que vuelvas." No dice "quiero que el tiempo retroceda." Dice: quiero tomarte la mano en este camino que no tiene fin. El camino sin fin — el extrañar que no tiene punto de llegada definido — no es el problema a resolver. Es el lugar donde quieren estar con esa persona, aunque sea en la imaginación, aunque sea en el recuerdo.
...
1. ¿A quién extrañas — de verdad, no la versión idealizada? ¿Qué parte específica de esa persona, o de ese tiempo, es lo que más duele que ya no esté? Sé concreta: no "la extraño mucho" sino qué, exactamente, es lo que falta.

2. Si pudieras decirle una sola cosa a esa persona — o a esa versión de ti misma, o a esa etapa — ¿qué dirías? No la que suena bien ni la que crees que deberías decir. La que quieres decir aunque no te quede bien.

3. ¿Qué llevas cargando de esa pérdida que ya es hora de soltar — no para olvidar, sino para que deje de pesar tanto sin ir a ninguna parte? ¿Qué significaría soltar eso sin traicionar lo que fue?

---

*Si extrañar también es tuyo, el Love Yourself Journal tiene un capítulo entero sobre relaciones y duelo — guiado por canciones de BTS que saben cómo nombrar lo que sentimos. 85+ prompts para ARMY que escribe lo que no siempre puede decir en voz alta.*
